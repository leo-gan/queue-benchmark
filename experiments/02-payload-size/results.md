...
Similar set (within 15% of fastest on this sample): steal-deque, crossbeam-queue, flume, crossbeam-channel, std-mpsc

See `rust/results.md`.

## javascript

Similar set (within 15% of fastest on this sample): fastq, steal-deque
